============================================================ DER Evaluation Harness — Málrómur Conversational ASR for Icelandic
Author: Páll Rúnarsson Engineer, Researcher at Reykjavík University

Developed in collaboration with: Tiro

Contact: pallr(at)ru.is

License: Creative Commons Attribution 4.0 International (CC BY 4.0) https://creativecommons.org/licenses/by/4.0/

DER Evaluation Harness
Python 3.10+ License: CC BY 4.0 Last updated: Mar 2026

General-purpose Diarization Error Rate (DER) evaluation for any diarization backend against any HuggingFace speech dataset with gold speaker annotations.
...
3. Install PyTorch
PyTorch must be installed before the rest of the requirements because pip cannot apply --index-url on a per-package basis from a requirements file.
...
Configuration
All defaults live in der_eval/config.py under the DEFAULTS dict. Edit that block to permanently change any setting. Every key can also be overridden at runtime via CLI arguments (see below).
...
The IAM user needs transcribe:StartTranscriptionJob, transcribe:GetTranscriptionJob, s3:PutObject permissions.
...
Acknowledgments
Dataset, processing code, and evaluation harness by Páll Rúnarsson, Reykjavík University / Language and Voice Lab.
Developed as part of the nationally funded Málrómur speech processing project, with advisory input from Professor Jón Guðnason
(Language and Voice Lab, Reykjavík University) and Dr. Michal Borsky (Tiro). Corpus provided via CLARIN-IS / Spjallrómur.Dataset provided via CLARIN-IS / Spjallrómur corpus.
